...
def repertoireAnalysis(repertoire, minNodeCount=10, minCloneCount=100):
    ...
    return [num_of_tcra,num_of_tcrb,num_of_all_tcr, unique_tcra_distribution, unique_tcrb_distribution, unique_all_tcr_distribution, simpson_index_tcra, simpson_index_tcrb, simpson_index_all_tcr, shannon_index_tcra, shannon_index_tcrb, shannon_index_all_tcr, public_count, public_cluster_count]
